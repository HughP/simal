...
server by adding them to the features directory. Features should exist 
in a self-contained directory with the following structure:
...
Note that some of the features in this directory are a part of the
Shindig project and are checked out automatically from the Apache
suvbversion repositories.
...
javascript coding conventions. This means that you should not be 
producing new globals and your feature should be compatible with Caja.

When committing a new feature, you should update the features.txt 
file by running the following script in a unix-like environment:

ls -R1a features/**/*.xml > features/features.txt

TODO: Instructions for regenerating features.txt for other operating 
system environments.
