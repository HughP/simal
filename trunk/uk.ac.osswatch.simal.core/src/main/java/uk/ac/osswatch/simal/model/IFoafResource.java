...
/**
 * An interface for wrapping repository specific representations of a FOAF
...
public interface IFoafResource extends Serializable {
   ...
   * 
   * @param asRecord
   *          if set to true then only a single JSON record is returned,otherwie
   *          a complete JSON file is returned
   * @return
   */
