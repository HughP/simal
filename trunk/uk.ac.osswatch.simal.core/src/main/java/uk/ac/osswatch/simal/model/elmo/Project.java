...
public class Project extends DoapResource implements IProject {
	...
	public Set<String> getCategories() {
		Set<org.openrdf.concepts.rdfs.Resource> resources = (Set) getProject().getDoapCategories();
		return getResourceURIs(resources);
	}

	@SuppressWarnings("unchecked")
	public Set<IPerson> getDevelopers() throws SimalRepositoryException {
		Set<org.openrdf.concepts.rdfs.Resource> resources = (Set) getProject().getDoapDevelopers();
	...
	public Set<IPerson> getDocumenters()  throws SimalRepositoryException {
		Set<org.openrdf.concepts.rdfs.Resource> resources = (Set) getProject().getDoapDocumenters();
		HashSet<IPerson> people = findPeople(resources);
		return people;
	}
	...
	public Set<String> getDownloadMirrors() {
		Set<org.openrdf.concepts.rdfs.Resource> resources = (Set) getProject().getDoapDownloadMirrors();
		return getResourceURIs(resources);
	}

	@SuppressWarnings("unchecked")
	public Set<String> getDownloadPages() {
		Set<org.openrdf.concepts.rdfs.Resource> resources = (Set) getProject().getDoapDownloadPages();
		return getResourceURIs(resources);
	}

	@SuppressWarnings("unchecked")
	public Set<IPerson> getHelpers() throws SimalRepositoryException {
		Set<org.openrdf.concepts.rdfs.Resource> resources = (Set) getProject().getDoapHelpers();
		HashSet<IPerson> people = findPeople(resources);
		return people;
	}
	...
	public Set<String> getHomepages() {
		Set<org.openrdf.concepts.rdfs.Resource> resources = (Set) getProject().getDoapHomepages();
		return getResourceURIs(resources);
	}

	@SuppressWarnings("unchecked")
	public Set<String> getIssueTrackers() {
		Set<org.openrdf.concepts.rdfs.Resource> resources = (Set) getProject().getDoapBugDatabases();
		return getResourceURIs(resources);
	}

	@SuppressWarnings("unchecked")
	public Set<Resource> getMailingLists() {
		Iterator elmoResources = getProject().getDoapMailingLists().iterator();
		HashSet<Resource> results = new HashSet(getProject().getDoapMailingLists().size());
		while (elmoResources.hasNext()) {
			results.add(new Resource((org.openrdf.concepts.rdfs.Resource) elmoResources.next()));
		}
		return results;
	}
	...
	public Set<IPerson> getMaintainers() throws SimalRepositoryException {
		Set<org.openrdf.concepts.rdfs.Resource> resources = (Set) getProject().getDoapMaintainers();
		HashSet<IPerson> people = findPeople(resources);
		return people;
	}
	...
	public Set<String> getOldHomepages() {
		Set<org.openrdf.concepts.rdfs.Resource> resources = (Set) getProject().getDoapOldHomepages();
		return getResourceURIs(resources);
	}
	...
	public Set<String> getScreenshots() {
		Set<org.openrdf.concepts.rdfs.Resource> resources = (Set) getProject().getDoapScreenshots();
		return getResourceURIs(resources);
	}

	@SuppressWarnings("unchecked")
	public Set<IPerson> getTesters() throws SimalRepositoryException {
		Set<org.openrdf.concepts.rdfs.Resource> resources = (Set) getProject().getDoapTesters();
		HashSet<IPerson> people = findPeople(resources);
		return people;
	}
	...
	public Set<IPerson> getTranslators() throws SimalRepositoryException {
		Set<org.openrdf.concepts.rdfs.Resource> resources = (Set) getProject().getDoapTranslators();
		HashSet<IPerson> people = findPeople(resources);
		return people;
	}
	...
	public Set<String> getWikis() {
		Set<org.openrdf.concepts.rdfs.Resource> resources = (Set) getProject().getDoapWikis();
		return getResourceURIs(resources);
	}
	 ...
	 */
	@SuppressWarnings("unchecked")
	private HashSet<IPerson> findPeople(Set<org.openrdf.concepts.rdfs.Resource> resources)
			throws SimalRepositoryException {
	 ...
	 */
	@SuppressWarnings("unchecked")
	private HashSet<IVersion> findReleases(Set<org.openrdf.concepts.rdfs.Resource> resources)
			throws SimalRepositoryException {
		Iterator<String> uris = getResourceURIs(resources).iterator();
	 ...
	 */
	@SuppressWarnings("unchecked")
	private Set<IRCS> findRepositories(Set<org.openrdf.concepts.rdfs.Resource> resources) throws SimalRepositoryException {
		Iterator<String> uris = getResourceURIs(resources).iterator();
