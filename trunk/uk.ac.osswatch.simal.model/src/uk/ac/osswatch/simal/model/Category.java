...
/**
 * A category describing one or more project types. Categories group
 * projects in some logical structure, such as standards implementation.
 *
 */
public class Category implements Serializable {
	...
	public Category(URL url) {
		setResourceURL(url);
	}


	/**
	 * Get the rdf resource this category refers to.
	 * @param resourceURL
	 */
