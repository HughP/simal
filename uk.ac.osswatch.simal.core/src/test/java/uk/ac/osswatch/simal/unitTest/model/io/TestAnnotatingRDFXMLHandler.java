...
public class TestAnnotatingRDFXMLHandler {
    ...
    AnnotatingRDFXMLHandler annotatingHandler = new AnnotatingRDFXMLHandler(annotatedFile);
    ...
    assertEquals("We don't seem to have collected the right number of project QNames", 1, qnames.size());
    QName qname = qnames.iterator().next();
    assertTrue("Generated project QName doesn't appear to be correct", qname.getLocalPart().startsWith(SimalRepository.DEFAULT_PROJECT_NAMESPACE_URI));
