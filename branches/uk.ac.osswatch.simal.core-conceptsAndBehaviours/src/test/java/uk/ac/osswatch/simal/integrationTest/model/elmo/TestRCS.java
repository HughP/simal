...
public class TestRCS extends BaseRepositoryTest {
  ...
  public void testRepositoriesLoaded() {
    assertEquals("Should have one repository defined", 1, repositories.size());
  }

  @Test
  public void testGetAnonRoots() {
    assertEquals("Anon roots are not correct",
        TEST_SIMAL_PROJECT_REPOSITORIES_ANON_ROOTS, repository.getAnonRoots()
            .toString());
  }
  ...
  public void testGetBrowse() {
    assertEquals("Browse URL is not correct",
        TEST_SIMAL_PROJECT_REPOSITORIES_BROWSE_URL, repository.getBrowse()
            .toString());
  }
  ...
  public void testGetLocations() {
    assertEquals("Locations are not correct",
        TEST_SIMAL_PROJECT_REPOSITORIES_LOCATIONS, repository.getLocations()
            .toString());
  }
}
