 ...
 *
 */
public interface IReleaseService extends IService {
	   /**
	    ...
	    */
	    public IReleaseService getOrCreate(String url) throws SimalRepositoryException;
	     ...
	     */
	    public IDoapRelease create(String uri) throws SimalRepositoryException,
