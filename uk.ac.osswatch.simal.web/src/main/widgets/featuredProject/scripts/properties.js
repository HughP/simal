...
var Properties = {
		...
		/**
		 * Get the base URL for the simal instance we are communicating with.
		 */
		getSimalURL: function() {
			return widget.preferences.getItem("simalURL");
		},
		...
		getSimalRestURL: function() {
			var simalURL = Properties.getSimalURL();
