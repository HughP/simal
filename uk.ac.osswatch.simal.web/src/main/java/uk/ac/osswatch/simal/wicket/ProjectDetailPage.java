...
public class ProjectDetailPage extends BasePage {
	 ...
	 * represented in the list using a link generated by calling the toString
	 ...
	 * @return
	 */
	private RepeatingView getRepeatingLinks(String repeaterWicketID,
			String itemWicketID, Set<Resource> resources) {
